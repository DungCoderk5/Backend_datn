...
async findAll({ page = 1, limit = 5, id, name, status, keyword, sortBy = 'name', sortOrder = 'asc' } = {}) {
  ...
  const allowedSortFields = ['categories_id', 'name', 'created_at', 'updated_at', 'status'];
...
async create({ name, slug, parent_id, image }) {
